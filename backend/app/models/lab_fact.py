...
class LabFact(Base):
    ...
    # Lab observation details
    test_name = Column(String, nullable=False)
    value = Column(String, nullable=False)
    unit = Column(String, nullable=True)
    reference_range = Column(String, nullable=True)
    flag = Column(String, nullable=True)  # e.g., 'normal', 'high', 'low', 'abnormal'
    # Observation timestamp (if available in the document)
    ...
    # Relationships
    session = relationship("Session", back_populates="lab_facts")
    document_extraction = relationship("DocumentExtraction", back_populates="lab_facts")
