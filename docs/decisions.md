...
4. **Calm Non-Diagnostic Patient Advisory**: When an emergency or urgent alert triggers, the Kiosk UI displays a calm, reassuring advisory banner (`docs/design.md` Section 8): *"Potential emergency symptoms were detected. Medical staff should assess you promptly. Medical staff have been notified."* Diagnostic claims (e.g., "You are having a myocardial infarction") to the patient are strictly prohibited.
